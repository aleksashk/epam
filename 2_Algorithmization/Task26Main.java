    ...
    public static void main(String[] args) {
        ...
        if (chose == 1) {
            ...
            while (d < Math.pow(num - 2, 2)) {//str 26
                ...
                if (temp[xUp][yDiagonal] == 0) {
                    a = xUp;
                    b = yDiagonal;
                }
                if (temp[xUp][yDiagonal] == -1) {
                    if (temp[xUp][y] == -1 && temp[xDownDiagonal][yDiagonal] == 0) {
                        a = xDownDiagonal;
                        b = yDiagonal;
                    } else if (temp[xUp][y] != -1) {
                        a = xUp;
                        b = yLeftDiagonal;
                    }
                }
            ...
            int[][] aray = new int[num - 2][num - 2];
            for (int i = 0, m = 1; i < num - 2; i++, m++) {
                for (int j = 0, n = 1; j < num - 2; j++, n++) {
                    aray[i][j] = temp[m][n];
                }
            }
            num -= 2;
