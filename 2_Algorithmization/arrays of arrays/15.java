...
public class Task25 {
    public static void main(String[] args) throws IOException {
        ...
        //замена всех нечетных элементов матрицы (i либо j нечетные) на значение максимального элемента, если выполняется это требование, 
        //то необходимо закоментировать два предыдущих цикла, а нижеследующие циклы раскоментировать
//        for (int i = 0; i < m; i++) {
//            for (int j = 0; j < n; j++) {
//                if(i % 2 != 0 || j % 2 != 0){
//                    aray[i][j] = maxNumber;
